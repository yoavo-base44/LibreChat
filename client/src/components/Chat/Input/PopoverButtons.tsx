      ...
      <div className="flex items-center justify-start">
        {endpointButtons.map((button, index) => (
          <Button
            ...
            className={cn(
              button.buttonClass,
              'border border-gray-300/50 focus:ring-1 focus:ring-purple-500/90 dark:border-gray-500/50 dark:focus:ring-purple-500',
        ...
        <div className="flex w-[150px] items-center justify-end">
          {additionalButtons[settingsView].map((button, index) => (
            <Button
              ...
              className={cn(
                button.buttonClass,
                'flex justify-center border border-gray-300/50 focus:ring-1 focus:ring-purple-500/90 dark:border-gray-500/50 dark:focus:ring-purple-500',
