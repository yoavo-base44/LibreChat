        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-purple-600 hover:text-white focus:bg-purple-600 focus:text-white dark:hover:bg-purple-700 dark:focus:bg-purple-700"
            >
